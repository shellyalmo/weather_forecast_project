...
from transform import keep_col, change_col_name, convert_kelvin_to_celsius, set_datetime_col_as_row_index
...
parser.add_argument("--city_id", help="enter city id")
...
new_df_to_sql = set_datetime_col_as_row_index(convert_kelvin_to_celsius(
    change_col_name(keep_col(convert_dict_to_df(filename)))))
