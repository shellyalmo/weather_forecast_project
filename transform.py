...
>>> keep_columns(df_test_keep_columns)
     main.temp  main.temp_min  main.temp_max  main.pressure  main.humidity  wind.speed  wind.deg
ITA        345            290            343             12             56         110       180
ESP        289            298            333             13             67          90       189
GRC        333            299            334             14             64          98       178
FRA        312            218            345             15             63          99       177
PRT        309            288            232             11             62         100       190
"""
...
def keep_columns(pandas_df):
    ...
    """
    return pandas_df[['main.temp','main.temp_min','main.temp_max','main.pressure','main.humidity','wind.speed','wind.deg']]
